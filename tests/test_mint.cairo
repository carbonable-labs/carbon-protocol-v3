...
use snforge_std::{
    ContractClassTrait, test_address, spy_events, EventSpy, CheatSpan, start_cheat_caller_address, stop_cheat_caller_address,
};
...
fn test_public_buy() {
    ...
    setup_project(project_address, project_carbon, times, absorptions,);
