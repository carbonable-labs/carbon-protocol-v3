...
// OpenZeppelin Contracts for Cairo v0.10.0 (token/erc1155/erc1155_receiver.cairo)
...
mod ERC1155ReceiverComponent {
    ...
    use carbon_v3::components::erc1155::interface::IERC1155_RECEIVER_ID;
    use carbon_v3::components::erc1155::interface::{IERC1155Receiver, IERC1155ReceiverCamel};
